    ...
    return (
        <div className={styles.nav}>
            ...
            <div className={styles.searchContainer}>
                <img className={styles.searchIcon} src='https://img.icons8.com/?size=2x&id=7695&format=png' alt=''/>
            ...
            <div className={styles.rightNav}>
                {auth.user && <div className={styles.user}>
                    <Link to="/settings">
                        <img alt='' src='https://cdn-icons-png.flaticon.com/512/921/921071.png' className={styles.userDp} />
                    </Link>
